	...
	namespace bind
	{
		...
		public:
			...
			R operator () ( Arg1 a1, Arg2 a2 )
			{
				...
				return ( *fn_ )( list[this->typeArg1], list[this->typeArg2] );
			}
		};
		...
		public:
			...
			R operator () ( Arg1 a1, Arg2 a2, Arg3 a3 )
			{
				...
				return ( *fn_ )( list[this->typeArg1], list[this->typeArg2], list[ this->typeArg3] );
			}
		};
		...
		public:
			...
			R operator () ( Arg1 a1, Arg2 a2, Arg3 a3, Arg4 a4 )
			{
				...
				return ( *fn_ )( list[ this->typeArg1 ], list[ this->typeArg2 ], list[ this->typeArg3 ], list[ this->typeArg4 ] );
			}
		};
		...
		public:
			...
			R operator () ( Arg1 a1, Arg2 a2, Arg3 a3, Arg4 a4, Arg5 a5 )
			{
				...
				return ( *fn_ )( list[ this->typeArg1 ], list[ this->typeArg2 ], list[ this->typeArg3 ], list[ this->typeArg4 ], list[ this->typeArg5 ] );
			}
		};
		...
		public:
			...
			R operator () ( Arg1 a1, Arg2 a2, Arg3 a3, Arg4 a4, Arg5 a5, Arg6 a6 )
			{
				...
				return ( *fn_ )( list[ this->typeArg1 ], list[ this->typeArg2 ], list[ this->typeArg3 ], list[ this->typeArg4 ], list[ this->typeArg5 ], list[ this->typeArg6 ] );
			}
		};
		...
		public:
			...
			R operator () ( Arg1 a1, Arg2 a2, Arg3 a3, Arg4 a4, Arg5 a5, Arg6 a6, Arg7 a7 )
			{
				...
				return ( *fn_ )( list[ this->typeArg1 ], list[ this->typeArg2 ], list[ this->typeArg3 ], list[ this->typeArg4 ], list[ this->typeArg5 ], list[ this->typeArg6 ], list[ this->typeArg7 ] );
			}
		};
		...
		public:
			...
			R operator () ( Arg1 a1, Arg2 a2, Arg3 a3, Arg4 a4, Arg5 a5, Arg6 a6, Arg7 a7, Arg8 a8 )
			{
				...
				return ( *fn_ )( list[ this->typeArg1 ], list[ this->typeArg2 ], list[ this->typeArg3 ], list[ this->typeArg4 ], list[ this->typeArg5 ], list[ this->typeArg6 ], list[ this->typeArg7 ], list[ this->typeArg8 ] );
			}
		};
		...
		public:
			...
			R operator () ( Arg1 a1, Arg2 a2, Arg3 a3, Arg4 a4, Arg5 a5, Arg6 a6, Arg7 a7, Arg8 a8, Arg9 a9 )
			{
				...
				return ( *fn_ )( list[ this->typeArg1 ], list[ this->typeArg2 ], list[ this->typeArg3 ], list[ this->typeArg4 ], list[ this->typeArg5 ], list[ this->typeArg6 ], list[ this->typeArg7 ], list[ this->typeArg8 ], list[ this->typeArg9 ] );
			}
		};
